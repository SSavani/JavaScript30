...
let areAllAdult = people.every((person) => new Date().getFullYear() - person.year >= 19);
...
// console.log("Index of comment to delete " + idx);
// comments.splice(idx, 1);
// console.table(comments);

let newComments = [...comments.slice(0, idx), ...comments.slice(idx + 1)];
